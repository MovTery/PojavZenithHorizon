...
class DownloadQuiltFragment : ModListFragment(), ModloaderDownloadListener {
    companion object {
    ...
    override fun init() {
        setIcon(ContextCompat.getDrawable(activity, R.drawable.ic_quilt))
        setNameText("Quilt")
        super.init()
    }
    ...
    override fun refresh(): Future<*> {
        return PojavApplication.sExecutorService.submit {
            try {
                ...
                val gameVersions = FabriclikeUtils.QUILT_UTILS.downloadGameVersions()
    ...
    private fun processInfo(gameVersions: Array<FabricVersion>) {
        ...
        gameVersions.forEach {
            ...
            loaderVersions = loaderVersions ?: FabriclikeUtils.QUILT_UTILS.downloadLoaderVersions(version)
        ...
        mFabricVersions.entries
            ...
            .forEach { (gameVersion, loaderVersions) ->
                ...
                //为整理好的Quilt版本设置Adapter
                val adapter = BaseModVersionListAdapter(modloaderListenerProxy, this, R.drawable.ic_quilt, loaderVersions)
                adapter.setOnItemClickListener(object : ModVersionListAdapter.OnItemClickListener {
                    override fun onClick(version: Any?) {
                        ...
                        Thread(FabriclikeDownloadTask(modloaderListenerProxy, FabriclikeUtils.QUILT_UTILS,
                            gameVersion, fabricVersion.version, true)).start()
                    }
                })
    ...
    override fun onDataNotAvailable() {
        Tools.runOnUiThread {
            ...
            Tools.dialog(context, context.getString(R.string.global_error),
                context.getString(R.string.fabric_dl_cant_read_meta, FabriclikeUtils.QUILT_UTILS.name)
            )
        }
    }
