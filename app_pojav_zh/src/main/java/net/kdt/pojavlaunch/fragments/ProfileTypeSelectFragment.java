...
public class ProfileTypeSelectFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.optifine_profile).setOnClickListener(v -> Tools.swapFragment(requireActivity(), DownloadOptiFineFragment.class,
        ...
        view.findViewById(R.id.modded_profile_forge).setOnClickListener((v)->
                Tools.swapFragment(requireActivity(), DownloadForgeFragment.class, DownloadForgeFragment.TAG, null));
        view.findViewById(R.id.zh_modded_profile_neoforge).setOnClickListener((v)->
                Tools.swapFragment(requireActivity(), DownloadNeoForgeFragment.class, DownloadNeoForgeFragment.TAG, null));
        view.findViewById(R.id.modded_profile_modpack).setOnClickListener((v)->
                Tools.swapFragment(requireActivity(), SelectModPackFragment.class, SelectModPackFragment.TAG, null));
