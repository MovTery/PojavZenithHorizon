...
public class CustomControlsActivity extends BaseActivity implements EditorExitable {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDrawerNavigationView.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_list_item_2,getResources().getStringArray(R.array.menu_customcontrol_customactivity)));
