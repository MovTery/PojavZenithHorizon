...
public interface ModpackApi {
     ...
     */
    default void handleInstallation(Context context, boolean isModPack,  ModDetail modDetail, int selectedVersion) {
        ...
        PojavApplication.sExecutorService.execute(() -> {
            try {
                ModLoader loaderInfo = installMod(isModPack, modDetail, selectedVersion);
     ...
     * @param selectedVersion The selected version
     */
    ModLoader installMod(boolean isModPack, ModDetail modDetail, int selectedVersion) throws IOException;
}
