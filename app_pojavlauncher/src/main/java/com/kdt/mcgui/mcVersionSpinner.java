...
public class mcVersionSpinner extends ExtendedTextView {
    ...
    public void openProfileEditor(FragmentActivity fragmentActivity) {
        ...
        if(currentSelection instanceof ProfileAdapterExtra) {
            ...
            Tools.swapFragment(fragmentActivity, ProfileEditorFragment.class, ProfileEditorFragment.TAG, true);
        }
    }
    ...
    private void performExtraAction(ProfileAdapterExtra extra) {
        ...
        if (extra.id == VERSION_SPINNER_PROFILE_CREATE) {
            Tools.swapFragment((FragmentActivity) getContext(), ProfileTypeSelectFragment.class,
                    ProfileTypeSelectFragment.TAG, true);
        }
    }
    ...
    private void getPopupWindow(){
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) mPopupWindow = new PopupWindow(mListView, getContext().getResources().getDimensionPixelOffset(R.dimen._290sdp), getContext().getResources().getDimensionPixelOffset(R.dimen._184sdp));
