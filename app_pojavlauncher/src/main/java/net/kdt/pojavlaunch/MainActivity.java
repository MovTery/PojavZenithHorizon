...
import static net.kdt.pojavlaunch.prefs.LauncherPreferences.PREF_SET_TO_CHINESE;
...
public class MainActivity extends BaseActivity implements ControlButtonMenuListener, EditorExitable, ServiceConnection {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ingameControlsEditorListener = (parent, view, position, id) -> {
            switch(position) {
                ...
                case 1: mControlLayout.addDrawer(new ControlDrawerData(getString(R.string.zh_controls_add_control_drawer))); break;
    ...
    private void runCraft(String versionId, JMinecraftVersionList.Version version) throws Throwable {
        ...
        if(PREF_SET_TO_CHINESE) ProfileLanguageSelector.setToChinese(minecraftProfile); //首次启动设置为中文
